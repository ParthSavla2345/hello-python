            ...
            steps {
                sshagent(credentials: ['gce-ssh']) {
                    sh '''
                        ...
                        ssh -o StrictHostKeyChecking=no ParthSavla2345@34.147.64.223 "mkdir -p /home/ParthSavla2345/app"    //appvm (to check IP address whoami)
                        scp -o StrictHostKeyChecking=no -r * ParthSavla2345@ 34.147.64.223:/home/ParthSavla2345/app/
